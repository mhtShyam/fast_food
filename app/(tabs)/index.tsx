import {FlatList, View, Pressable, Image,Text,TouchableOpacity} from "react-native";
...
export default function Index() {
  return (
    <SafeAreaView className="flex-1 bg-white">
       ...
       ListHeaderComponent={()=>(
           <View className="flex-between flex-row w-full px-5 py-5">
